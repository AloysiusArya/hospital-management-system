				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Admin | List Apoteker</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Admin</span>
								...
								<div class="col-md-12">
									...
									<table class="table table-hover" id="sample-table-1">
										<thead>
											<tr>
												<th class="center">#</th>
												<th class="hidden-xs">Nama Apoteker</th>
												<th>Username</th>
												<th>Password</th>
</tr>
										</thead>
...
$cnt=1;
$query = "SELECT * FROM user_login WHERE Nama_Apoteker != '0' AND Nama_Apoteker != ''";
...
?>
                                        <tr>
												...
												<td class="hidden-xs"><?php echo $row['Nama_Apoteker'];?></td>
