...
$level = 4;
$query=mysqli_query($koneksi,"insert into user_login(Nama_Apoteker,Level,Username,Password) values('$namadokter','$level','$username','$hashedPassword')");
	if($query)
	{
		echo "<script>alert('Apoteker sukses ditambahkan');</script>";
	}
...
<html lang="en">
	<head>
		<title>Admin| Tambah Apoteker</title>
...
<div class="row">
<div class="col-sm-8">
<h1 class="mainTitle">Admin | Tambah Apoteker</h1>
</div>
<ol class="breadcrumb">
<li>
<span>Tambah Apoteker</span>
</li>
<li class="active">
<span>Tambah Apoteker</span>
</li>
...
<h5 class="panel-title">Tambah Apoteker</h5>
</div>
...
<input type="text" name="patname" class="form-control"  placeholder="Nama Apoteker" required="true">
</div>
<div class="form-group">
<label for="fess">
Username
