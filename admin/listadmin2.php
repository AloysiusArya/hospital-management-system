...
if(isset($_GET['cancel']))
{
	...
	$query1 = "SELECT * FROM user_login WHERE login_id ='".$_GET['id']."'";
	$result1 = mysqli_query($koneksi, $query1);
	$row1 = mysqli_fetch_array($result1);
	$namadokter1 = $row1['Nama_Dokter'];

	mysqli_query($koneksi,"delete from user_login where login_id ='".$_GET['id']."'");
	// mysqli_query($koneksi,"delete from dokter where Nama_Dokter = '$namadokter1'");
        $_SESSION['msg']="Dokter Dihapus !!";}
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Admin | List Dokter</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Admin</span>
...
$cnt=1;
$query = "SELECT * FROM user_login WHERE Nama_Dokter != '0'";
