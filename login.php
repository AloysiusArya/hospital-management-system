...
if (isset($_POST['login'])){
    ...
    if(empty($err)){
        ...
        $r1 = mysqli_fetch_array($q1);
        if($r1['Level'] == 2){
        header("location:dokter/dokterlist.php");
        exit();
        }
        elseif ($r1['Level'] == 3) {
         header("location:pasien/pasienhistori.php");
         exit();
        }
        elseif ($r1['Level'] == 4) {
         header("location:apoteker/apotekerlist.php");
         exit();
        }
        elseif ($r1['Level'] == 1) {
...
<!DOCTYPE html>
   ...
   <head>
      ...
      <title>Login Rhodes Island Clinic</title>
   </head>
   <body>
