...
$userstatus=1;
$docstatus=1;
$query=mysqli_query($koneksi,"insert into jadwal_pasien(Nama_Dokter,harga,tanggal,jam,status_pasien,status_dokter,Nama_Pasien) values('$doctorid','$fees','$appdate','$time','$userstatus','$docstatus','$nama_pasien')");
	if($query)
	{
    ...
    <div class="main-content" >
        <div class="wrap-content container" id="container">
            ...
            <section id="page-title">
                <div class="row">
                    <div class="col-sm-8">
                        <h1 class="mainTitle">Pasien | Book Appointment</h1>
                                                        </div>
                    <ol class="breadcrumb">
                        <li>
                            <span>User</span>
...
<div class="form-group">
                ...
                <select name="Doctorspecialization" class="form-control" onChange="getdoctor(this.value);" required="required">
                                                    ...
                                                    <?php $ret=mysqli_query($koneksi,"select * from dokter");
while($row=mysqli_fetch_array($ret))
{
?>
																<option value="<?php echo htmlentities($row['Spesialisasi']);?>">
																	<?php echo htmlentities($row['Spesialisasi']);?>
																</option>
																<?php } ?>
                                                </select>
                                            </div>
