...
if(isset($_GET['cancel']))
		  {
		          mysqli_query($koneksi,"update jadwal_pasien set status_pasien='0' where ID_JADWAL = '".$_GET['id']."'");
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Pasien | History</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>User</span>
...
$cnt=1;
$query = "SELECT * FROM jadwal_pasien WHERE Nama_Pasien = '$nama_pasien'";
...
?>
                                        <tr>
												...
												<td><?php if($row['status_pasien'] == '1' && $row['status_dokter'] == '1' && $row['aturan_pakai']=='' && $row['aturan_obat']==''){ echo "Aktif";}if(($row['status_pasien']==0) && ($row['status_dokter']==1))  
{
...
{ ?>
	...
	<a href="pasienhistori.php?id=<?php echo $row['ID_JADWAL']?>&cancel=update" onClick="return confirm('Are you sure you want to cancel this appointment ?')"class="btn btn-transparent btn-xs tooltips" title="Cancel Appointment" tooltip-placement="top" tooltip="Remove">Cancel</a>
